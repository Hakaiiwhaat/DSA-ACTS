    ...
    public ArrayList<Integer> sortMethod() {
        ...
        if (crtArrayLst.numesLen == 0) {
            ...
            while (!inOrder) { // while false
                ...
                for(out=0; out<crtArrayLst.numesLen; out++){ // outer loop{
                    min = out; // minimum
                    for(in=out+1; in<crtArrayLst.numesLen; in++){ // inner loop
                        if (crtArrayLst.numbersList.get(in) <= crtArrayLst.numbersList.get(min)) {
                    ...
                    if (rounds != crtArrayLst.numesLen + 1) {
                        ...
                        for (int i = 0; i < crtArrayLst.numesLen; i++) {
                            sb.append(crtArrayLst.numbersList.get(i)).append(" ");
                        }
                        sb.append("\n");
...
//            StringBuilder sb = new StringBuilder();
//            sb.append("Round " + rounds + " : ");
//            for (int i = 0; i < crtArrayLst.numesLen; i++) { //issue will print the same length as numesLen even if already sorted
//                sb.append(crtArrayLst.numbers[i]).append(" ");
//            }displayArea2.append(sb.toString());
        }
